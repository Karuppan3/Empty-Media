...
internal object ShapeTokens {
    ...
    val CornerExtraLarge = RoundedCornerShape(size = 28.0.dp)
    ...
    val CornerExtraSmall = RoundedCornerShape(size = 4.0.dp)
    ...
    val CornerLarge = RoundedCornerShape(size = 16.0.dp)
    ...
    val CornerMedium = RoundedCornerShape(size = 12.0.dp)
    val CornerNone = RectangleShape
    val CornerSmall = RoundedCornerShape(size = 8.0.dp)
}